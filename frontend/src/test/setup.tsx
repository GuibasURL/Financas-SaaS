...
// chegaria como texto ("[object FormData]") em vez de multipart. Usa as
// versões nativas do Node, que o MSW entende. (Só afeta os testes; no
// navegador de verdade o upload usa as do browser.) O FormData do Node não
// é exportado por nenhum módulo, então vem de uma Response.
const nodeFormData = await new Response("", {
  headers: { "content-type": "application/x-www-form-urlencoded" },
}).formData();
Object.assign(globalThis, { FormData: nodeFormData.constructor, File: NodeFile, Blob: NodeBlob });
